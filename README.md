## Instructions
1. First, the audio wav files need to be downloaded using the tool [yt-dlp](https://www.mankier.com/1/yt-dlp). For this run `audio_retrieval.py`. Note that the each file is about 880 KB, totally upto 25.3 GB!
